    ...
    public void makeUsers(){
        ...
        for (int i = 0; i < USERS_COUNT; i++) {
            User user = User.builder()
                    .username("user"+MakeRandomValues.getRandomString())
                    .password("1234")
                    .role("ROLE_USER")
                    .description("description"+MakeRandomValues.getRandomString())
                    .email(MakeRandomValues.getRandomString()+"@email.com")
                    .followingsCount(0)
                    .followersCount(0)
